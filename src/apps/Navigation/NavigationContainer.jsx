...
import logoIcon from '../../style/images/erp-logo.png';
// import logoText from '@/style/images/logo-text.svg';
import logoText from '@/style/images/erp-logo-text.png';
...
function Sidebar({ collapsible, isMobile = false }) {
  ...
  const items = [
    ...
    },
    {
      key: 'people',
      icon: <UserOutlined />,
      label: <Link to={'/people'}>{translate('Order List')}</Link>,
    },
    {
      key: 'company',
      icon: <ShopOutlined />,
    ...
    // { key: 'order', icon: <ShopOutlined />, label: <Link to={'/ordertable'}>{translate('Order')}</Link>},
